...
public class ProjectTest {
    ...
    void checkIfALotOfMistakes(){
        ...
        Input input = new Input() {
            int counter=0;
            String[] inputs={"guess_word", "s","s","s","s","s","s","exit"};
            @Override
            public String read() {
    ...
    private static Stream<Arguments> guessWordMethodProvider(){
        return Stream.of(
            ...
            Arguments.of(new String[] {"iHateLSP"}, new String[] {"guess_word", "a", "a","a","i","b","ihatelsp","exit"}),
            ...
            Arguments.of(new String[] {"Pashalka"}, new String[] {"guess_word","o","o","o","o","o","pashal", "pashalll","hh","he","pashalka" ,"exit"})
        );
    }
    ...
    // я не очень понимаю как писать остальные тесты......,
    // например, что правильно считается количество ошибок, разве что тестами выше
}
