...
public class MetricPopularityTest {
    ...
    private static ArrayList<ArrayList<String>> getMetric(List<Long> statitics) {
        ...
        for (int i = 0; i < statitics.size(); i += 2) {
            metrics.add(new ArrayList<>(List.of(new String[] {String.valueOf(statitics.get(i)),
                                                              String.valueOf(statitics.get(
                                                                  i + 1))})));
        }
        return metrics;
    }
    ...
    public void update_shouldCorrectlyUpdateMetrics(
