...
public class MetricCommonTest {
    ...
    private static ArrayList<ArrayList<String>> getMetric(
        String minDate,
        String maxDate,
        Long countOfRequest,
        BigInteger sumOfResponseSize
    ) {
    ...
    public void update_shouldUpdateMetrics(MetricCommon metricCommon, ArrayList<ArrayList<String>> expectedArray) {
        ArrayList<ArrayList<String>> actualArray = metricCommon.getMetricData();
