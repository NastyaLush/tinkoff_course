...
public class DirectTest {
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
            .include(DirectTest.class.getSimpleName())
    ...
    public void setup()
        throws Exception {
        student = new Student("Alexander", 2);
        method = Student.class.getMethod("name");
        MethodHandles.Lookup publicLookup = MethodHandles.publicLookup();
        MethodType mt = MethodType.methodType(String.class);
        concatMH = publicLookup.findVirtual(Student.class, "name", mt);
        nameGetter = createGetter(MethodHandles.lookup(), concatMH);

        // сделаем методы полиморфными, против jit
        Method method2 = Student.class.getMethod("name");
        Method method3 = Student.class.getMethod("hashCode");
